...
Route::prefix('payroll')->group(function () {
    Route::get('/', [FinancePayrollController::class, 'index'])->name('finance.payroll.index')->middleware('role:pegawai,kepala-sekolah');
    ...
    Route::get('slip/{payroll}', [FinancePayrollController::class, 'showSlip'])->name('finance.payroll.show.slip')->middleware('role:bendahara,pegawai,kepala-sekolah');
    ...
    Route::get('download/slip/{payroll}', [FinancePayrollController::class, 'downloadSlip'])->name('finance.payroll.download.slip')->middleware('role:bendahara,pegawai,kepala-sekolah');
...
Route::prefix('report')->group(function () {
    ...
    Route::get('bill-per-type', [FinanceReportController::class, 'billPerType'])->name('finance.report.bill-per-type')->middleware('role:kasir,bendahara,wali-kelas,pegawai,kepala-sekolah');
    ...
    Route::get('download/excel/bill-per-type', [FinanceReportController::class, 'downloadExcelBillPerType'])->name('finance.report.download.excel.bill-per-type')->middleware('role:kasir,wali-kelas,pegawai,kepala-sekolah');
    ...
    Route::get('download/pdf/bill-per-type', [FinanceReportController::class, 'downloadPdfBillPerType'])->name('finance.report.download.pdf.bill-per-type')->middleware('role:kasir,wali-kelas,pegawai,kepala-sekolah');
    ...
    Route::post('datatable/bill-per-type', [FinanceReportController::class, 'datatableBillPerType'])->name('finance.report.datatable.bill-per-type')->middleware('role:kasir,wali-kelas,pegawai,kepala-sekolah');
    ...
    Route::post('get/total-bill-per-type', [FinanceReportController::class, 'getTotalBillPerType'])->name('finance.report.get.total-bill-per-type')->middleware('role:kasir,bendahara,wali-kelas,pegawai,kepala-sekolah');
