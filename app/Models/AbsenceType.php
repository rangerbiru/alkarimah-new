...
class AbsenceType extends Model
{
    ...
    {
        return Attribute::make(
            get: fn() => ($this->flag == AbsenceTypeFlag::Umum) ? __('label.general') : __('label.excul')
        );
    }

    protected function isUmum(): Attribute
    {
        return Attribute::make(
            get: fn() => $this->flag == AbsenceTypeFlag::Umum
        );
    }

    protected function isEkskul(): Attribute
    {
        return Attribute::make(
            get: fn() => $this->flag == AbsenceTypeFlag::Ekskul
        );
    }
