...
@section('header')
    ...
    <div class="ms-sm-1 ms-0" style="min-width: 200px;">
        <x-form.select id="year" :option="$years" :old="$year->id" />
    </div>
@endsection
    ...
    <div class="card custom-card">
        <div class="card-body">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h6 class="mt-0 mb-1">{{ __('label.payment_progress') }}</h6>
                </div>
            </div>
    ...
    <div class="row">
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="mt-0 mb-1">{{ __('string.todays_receipts_per_recipient') }}</h6>
                        </div>
                    </div>
            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="mt-0 mb-1">{{ __('string.todays_receipts_per_class') }}</h6>
                        </div>
                    </div>
        ...
        <div class="col-md-7">
            <div class="card custom-card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="me-2"><i class="bx bx-credit-card-alt text-primary" style="font-size: 22px;"></i>
                        </div>
                        <div>
                            <h6 class="mt-0 mb-1">{{ __('string.todays_receipts_per_type') }}</h6>
                        </div>
                    </div>
    ...
    <div class="card custom-card">
        <div class="card-body">
            <div class="d-flex align-items-center mb-2">
                ...
                <div>
                    <h6 class="mt-0 mb-1">{{ __('label.todays_transaction') }}</h6>
                </div>
            </div>
