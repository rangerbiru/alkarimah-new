...
@section('title', $title)
@section('header')
    <x-section-page :label="$title" :icon="$icon" breadcrumb="dashboard" />
@endsection
...
@section('content')
    ...
    @include('backend.employee.attendance-report.summary')
@endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            window.LaravelDataTables["table-attendance"] = $("#table-attendance").DataTable({
                ...
                ajax: {
                    url: "{{ route('employee.attendance-report.datatable') }}",
                    type: "POST"
                },
                processing: true,
                serverSide: true,
