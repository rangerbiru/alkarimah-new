...
@section('title', $title)
@section('header')
    <x-section-page :label="$title" :icon="$icon" breadcrumb="employee/submission/item/create" />
@endsection

@section('content')
    <div class="row">
        <div class="col-lg-12">
            <form method="post" action="{{ route('employee.submission.item.store') }}" class="form-block"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <x-form.button-submit :cancel-route="route('employee.submission.create')" />
                    </div>
                </div>
            </form>
        </div>
