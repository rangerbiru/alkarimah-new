...
<x-section-page
    :label="$title"
    :icon="$icon"
    breadcrumb="finance/bill/setup/setting"
/>
@endsection
                        ...
                        <div class="card">
                            <div class="card-body p-3 bg-light">
                                ...
                                <div class="form-check mb-2">
                                    <input class="form-check-input" type="radio" name="method" id="method-class" value="class" style="margin-top: .5em;" checked>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="method" id="method-student" value="student" style="margin-top: .5em;">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4">
                                <x-form.select
                                    id="education-level"
                                    :option="$educations"
                                    :data-placeholder="__('label.level_education')"
                                />
                            </div>
                            <div class="col-sm-6 col-md-4 form-filter-class">
                                <x-form.select
                                    id="class-level"
                                    :option="[]"
                                    :data-placeholder="__('label.level_class') . ' (' . __('label.optional') . ')'"
                                    loading
                                />
                            </div>
                            <div class="col-sm-6 col-md-4 form-filter-student">
                                <x-form.select
                                    id="class"
                                    :option="[]"
                                    :data-placeholder="__('label.class')"
                                />
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <button type="button" id="btn-save" class="btn btn-primary" style="padding-bottom: 6px;">
...
$(document).ready(function() {
    ...
    $("#btn-save").click(function() {
        ...
        btn.addClass("btn-loader").html("<span class='loading'><i class='ri-refresh-line fs-16'></i></span> &nbsp;&nbsp;{{ __('label.generating') }}...").attr("disabled", true)
        ...
        $.ajax({
            ...
            success: function(response) {
                btn.removeClass("btn-loader").html("<i class='fa-solid fa-refresh'></i> &nbsp;{{ __('label.generate') }}").removeAttr("disabled")
...
function getClass()
{
    const formData = {education: education_level, class: class_level}
