...
<div class="card card-tab mb-3">
    <div class="card-body p-3">
        <div class="d-flex">
            ...
            <div class="ms-auto">
                <img src="{{ ($transaction->is_setor_tabungan) ? $transaction->method->image_payment : asset('images/icons/min.png') }}" class="img-thumbnail" style="height: 47px;" />
            </div>
        </div>
        ...
        <div class="d-flex mb-2">
            <div>{{ __('label.savings_deposit_nominal') }}</div>
            <div class="ms-auto">{{ number_format($transaction->subtotal, 0, '', '.') }}</div>
        </div>
        ...
        <div class="d-flex mb-2">
            ...
            <div class="ms-auto fw-bold text-success">{{ number_format($transaction->bills->after, 0, '', '.') }}</div>
        </div>
    </div>
</div>
@endsection
