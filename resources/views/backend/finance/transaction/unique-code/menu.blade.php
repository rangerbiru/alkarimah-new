    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a href="{{ route('finance.transaction.unique-code', 'waiting') }}" class="nav-link{{ $set_waiting }}">
                        <i class="fa-solid fa-clipboard-list"></i> &nbsp;Menunggu Persetujuan
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('finance.transaction.unique-code', 'accepted') }}" class="nav-link{{ $set_accepted }}">
                        <i class="fa-solid fa-clipboard-check"></i> &nbsp;Diterima
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('finance.transaction.unique-code', 'rejected') }}" class="nav-link{{ $set_rejected }}">
