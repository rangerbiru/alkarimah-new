...
<div class="card">
    <div class="card-body">
        <form id="form" method="post" action="{{ route('finance.transaction.store.verify-cash', $deposit->encrypted_id) }}" class="form-block">
            @csrf
            ...
            <x-form.button-submit
                ...
                :cancel-route="route('finance.transaction.cash', 'waiting')"
            />
        </form>
    </div>
</div>
