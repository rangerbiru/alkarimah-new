...
@section('title', $title)
@section('header')
    <x-section-page :label="$title" :icon="$icon" breadcrumb="academic/student/create" />
@endsection
...
@section('content')
    <div class="card">
        <div class="card-body p-1">
            ...
            <form method="post" action="{{ route('academic.student.store') }}" class="form-block"
                    ...
                    <div class="tab-pane active border-0 pt-2" id="form-identity" role="tabpanel">
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <x-form.input-text name="nis" :label="__('label.nis')" :old="old('nis')" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <x-form.input-text name="nik" :label="__('label.nik')" :old="old('nik')" optional />
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <x-form.input-text name="nisn" :label="__('label.nisn')" :old="old('nisn')" optional />
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <x-form.input-text name="nis_local" :label="__('label.nis_local')" :old="old('nis_local')" optional />
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <x-form.input-text type="hidden" name="id_parent" id="parent-id" :old="old('id_parent')"
                                    readonly />
                                <x-form.input-group-button name="parent" id="parent" :label="__('label.parent')"
                                    :old="old('parent')" button-id="btn-choose-parent"
                                    button-label="<i class='fa-solid fa-search'></i>" readonly />
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <x-form.select name="religion" :label="__('label.religion')" :option="$religions" :old="old('religion')" />
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <x-form.date-picker name="birthdate" picker-type="date" :label="__('label.birthdate')"
                                    :old="old('birthdate')" optional />
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <x-form.input-text name="birthplace" :label="__('label.birthplace')" :old="old('birthplace')" optional />
                            </div>
                        </div>

                        <x-form.text-area name="address" :label="__('label.address')" :old="old('address')" optional />
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <x-form.select id="education-level" name="level_education" :label="__('label.level_education')"
                                    :old="old('level_education')" :option="$educations" />
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <x-form.select id="class" name="id_class" :label="__('label.class')" :old="old('id_class')"
                                    :option="[]" loading />
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <x-form.input-text name="school_from" :label="__('label.school_from')" :old="old('school_from')" optional />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <x-form.radio name="beasiswa" :label="__('label.scholarship')" :old="old('beasiswa')" :option="$yesno" />
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-4">
                                <x-form.input-file name="photo" id="photo" :label="__('label.photo')" accept-file="image"
                                    image-height="100px" :info="__('string.info_photo')" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <x-form.input-group-mask name="spp" :label="__('label.spp')" :old="old('spp')"
                                    mask="nominal" addon="Rp" optional />
                            </div>
                            <div class="col-md-6">
                                <x-form.input-text name="location" :label="__('label.location')" :old="old('location')" optional />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 col-md-4">
                                <x-form.radio name="status" :label="__('label.status')" :old="old('status')" :option="$activation" />
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script>
        ...
        let exculs = JSON.parse('{!! json_encode(old('exculs', [])) !!}')
