...
<x-section-page
    :label="$title"
    :icon="$icon"
    breadcrumb="academic/student/create"
/>
@endsection
...
<div class="card">
    <div class="card-body p-1">
        ...
        <form method="post" action="{{ route('academic.student.store') }}" class="form-block" enctype="multipart/form-data">
            @csrf
