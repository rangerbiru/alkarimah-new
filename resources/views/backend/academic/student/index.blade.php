    ...
    <div class="card-body">
        <div class="row mb-3">
            ...
            <div class="col-sm-5 col-md-9">
                ...
                <div class="btn-group">
                    <button type="button" class="btn btn-info label-btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    let url_history_move = "{{ route('academic.student.history.displacement', 0) }}"
