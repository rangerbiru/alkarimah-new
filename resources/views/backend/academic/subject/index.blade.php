...
@section('title', $title)
@section('header')
    <x-section-page :label="$title" :icon="$icon" breadcrumb="academic/subject" />
@endsection

@section('content')
    <div class="card">
        <div class="card-body">
            <x-section-page-action :label="$title" :icon="$icon" :count="$count" :create-route="route('academic.subject.create')" />
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: (data, type, row, meta) => {
                            return "<span class='text-uppercase'>" + htmlEntities(row
                                .level_education) + "</span>"
                        }
                    },
                    {
                        class: "align-middle",
                        render: (data, type, row, meta) => {
                            return htmlEntities(row.lesson_hours) + " JP"
                        }
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            let url_destroy = "{{ route('academic.subject.destroy', ':id') }}"
                            let url_edit = "{{ route('academic.subject.edit', ':id') }}"
