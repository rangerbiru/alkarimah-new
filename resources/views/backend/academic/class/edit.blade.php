...
<x-section-page
    :label="$title"
    :icon="$icon"
    breadcrumb="academic/class/edit"
    :breadcrumb-data="$class->encrypted_id"
/>
@endsection
...
<div class="card">
    <div class="card-body">
        <form method="post" action="{{ route('academic.class.update', $class->encrypted_id) }}" class="form-block">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                <div class="col-md-4">
                    <x-form.select
                        ...
                        :old="old('id_wali_kelas', $class->id_wali_kelas)"
                        :option="$wali_kelas"
                    />
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <x-form.select
                        ...
                        :old="old('level_education', $class->level_education->value)"
                        :option="$educations"
                    />
                </div>
                <div class="col-sm-6 col-md-3">
...
let education_level = "{{ old('level_education', $class->level_education->value) }}"
let class_level = "{{ old('level_class', $class->level_class) }}"
