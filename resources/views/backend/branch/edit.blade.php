...
<x-section-page
    :label="$title"
    :icon="$icon"
    breadcrumb="branch/edit"
        :breadcrumb-data="$branch->encrypted_id"
/>
@endsection
...
<div class="card">
    <div class="card-body">
        <form method="post" action="{{ route('branch.update', $branch->encrypted_id) }}" class="form-block">
            @csrf
            @method('PUT')
            ...
            <x-form.input-group
                ...
                :old="old('address', $branch->address)"
            ...
            <div class="row">
                <div class="col-sm-6 col-md-4">
                    <x-form.input-text
                        ...
                        :old="old('username', $branch->user->name)"
                    />
                </div>
                <div class="col-sm-6 col-md-4">
                    <x-form.radio
                        ...
                        :old="old('gender', $branch->user->gender->value)"
                        :option="$genders"
                    />
                </div>
            </div>
