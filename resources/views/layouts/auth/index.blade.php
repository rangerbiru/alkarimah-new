            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-md-12 col-sm-10">
                        <div class="card custom-card mb-0 cover-background overflow-hidden rounded-end rounded-0 d-block d-sm-none" style="height: 250px;">
                            <div class="card-img-overlay d-flex align-items-center p-0 rounded-0">
                                <div class="card-body p-3 text-center rectangle3">
                                    <div>
                                        <a href="{{ route('base') }}">
                                            <img src="{{ asset('images/logo.png') }}" style="width: 100px;" alt="logo" class="desktop-dark">
                                        </a>
                                    </div>
                                    <h5 class="mt-4 op-9 text-fixed-white">Pondok Pesantren</h5>
                                    <h4 class="op-9 text-fixed-white">Ibnu Abbas As-salafy</h4>

                                    <small class="text-fixed-white">Masaran - Sragen Jawa Tengah 57282</small>
                                </div>
                            </div>
                        </div>
