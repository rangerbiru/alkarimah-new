@php
    ...
    $set_finance_report_ongoingcollectionspp =
        $action == 'report' && $function == 'ongoing-collection-spp' ? ' active' : '';
...
<li class="slide has-sub{{ $set_finance_bill_open }}">
    ...
    <ul class="slide-menu child1">
        ...
        <li class="slide">
            <a href="{{ route('finance.bill.discount.index') }}"
                class="side-menu__item{{ $set_finance_bill_discount }}">
                {{ __('label.discount') }}
            </a>
        </li>
    </ul>
...
<li class="slide has-sub{{ $set_finance_report_open }}">
    ...
    <ul class="slide-menu child1">
        <li class="slide">
            <a href="{{ route('finance.report.bill-not-paid') }}"
                class="side-menu__item{{ $set_finance_report_billnotpaid }}">
        ...
        <li class="slide">
            <a href="{{ route('finance.report.bill-progress') }}"
                class="side-menu__item{{ $set_finance_report_billprogress }}">
        ...
        <li class="slide">
            <a href="{{ route('finance.report.bill-total') }}"
                class="side-menu__item{{ $set_finance_report_billtotal }}">
                {{ __('label.bill_total') }}
            </a>
        </li>
        <li class="slide">
            <a href="{{ route('finance.report.payment-method') }}"
                class="side-menu__item{{ $set_finance_report_paymentmethod }}">
                {{ __('label.payment_method') }}
            </a>
        </li>
        <li class="slide">
            <a href="{{ route('finance.report.outstanding-arrears') }}"
                class="side-menu__item{{ $set_finance_report_outstandingarrears }}">
                {{ __('label.outstanding_arrears') }}
            </a>
        </li>
        <li class="slide">
            <a href="{{ route('finance.report.ongoing-collection-spp') }}"
                class="side-menu__item{{ $set_finance_report_ongoingcollectionspp }}">
                {{ __('label.ongoing_collection_spp') }}
            </a>
        </li>
        <li class="slide">
            <a href="{{ route('finance.report.donation') }}"
                class="side-menu__item{{ $set_finance_report_donation }}">
                {{ __('label.donation') }}
            </a>
        </li>
    </ul>
